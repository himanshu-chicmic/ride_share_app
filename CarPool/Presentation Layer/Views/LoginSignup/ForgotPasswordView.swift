...
struct ForgotPasswordView: View {
    ...
    @State var requestType: RequestType = .sendOtpEmail
        ...
        VStack {
            ...
            Button {
                withAnimation {
                    switch requestType {
                    case .sendOtpEmail:
                        baseViewModel.createFogotPasswordApiCall(httpMethod: .POST, requestType: .sendOtpEmail, data: [Constants.JsonKeys.email: textFieldValues[0].0])
                        requestType = .emailOtpVerify
                        break
                    case .emailOtpVerify:
                        baseViewModel.createFogotPasswordApiCall(httpMethod: .POST, requestType: .emailOtpVerify, data: [Constants.JsonKeys.email: textFieldValues[0].0, Constants.JsonKeys.otp: textFieldValues[1].0])
                    ...
                    default:
                        baseViewModel.createFogotPasswordApiCall(
                            httpMethod: .POST,
                            requestType: .resetPassword,
                            data: [Constants.JsonKeys.email: textFieldValues[0].0, Constants.JsonKeys.password: textFieldValues[2].0, Constants.JsonKeys.passwordConfirmation: textFieldValues[3].0]
                        )
                    }
                }
            } label: {
